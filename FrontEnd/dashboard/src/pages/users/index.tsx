...
import { SelectUser } from "../../store/action-creators/userActions";
    ...
    <Box sx={{ width: "100%" }}>
      {user.role === "Administrators" && (
        <Box
          ...
          alignItems="flex-end"
        >
          <Button variant="contained" href="sign-up">Add new user</Button>
        </Box>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!row.isLocked && (
                        <TableCell sx={{color: "green"}}>False</TableCell>
                      ) || (
                        <TableCell sx={{color: "red"}}>True</TableCell>
                      )}
